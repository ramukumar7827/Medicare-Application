...
import 'package:medicare/screen/home/doctor_main_page.dart';
...
class _DoctorLoginScreenState extends State<DoctorLoginScreen> {
  ...
  void _onSubmit() async {
    if (_formkey.currentState!.validate()) {
      ...
      var response = await dataService.loginUser('/loginDoctor', data);
      if (response != null) {
        ...
        if (jsonResponse['success'] == false) {
          ...
          await profileDetails.fetchDoctorProfile();
          Navigator.pushReplacement(context,
              MaterialPageRoute(builder: (context) => DoctorMainTabScreen()));
        }
      } else {
